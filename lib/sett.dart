      ...
      body: Container(
        ...
        child: ListView(
            children: [
              ...
              SizedBox(height: 15,),
              ListTile(
                title: Text("Cellular Data", style: TextStyle(
                    fontWeight: FontWeight.bold, fontSize: 18.8),),
              ...
              ListTile(
                title: Text("Wi-Fi", style: TextStyle(
                    fontWeight: FontWeight.bold, fontSize: 18.8),),
              ...
              ListTile(
                title: Text('Allow notifications', style: TextStyle(
                    fontWeight: FontWeight.bold, fontSize: 20.0),),
                trailing: Radio(value: 'allow',
              ...
              Divider(thickness: 2,),
              ListTile(
                title: Text('Turn off notifications', style: TextStyle(
                    fontWeight: FontWeight.bold, fontSize: 18.0),),
                trailing: Radio(value: 'Turn off',
                    groupValue: notification,
                    onChanged: (value) {
                      setState(() {
                        notification = value;
